...
headers = ["Name", "Jahrgang", "Rebsorte", "Weingut", "Produktbezeichnung", "Ort", "Passt gut zu", "Herkunftsland", "Anlass", "Größe des Winzers", "Winzer", "Region", "Herstellungsmethode", "Art", "Lagerfähigkeit", "Charakteristik", "Beschreibung"]
