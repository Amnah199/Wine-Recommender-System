"""
Script for inserting data in posgreSQL schema by use of sqlalchemy library.
...
# Create connection with the posgreSQL db
...
# Insert dataframes into tables in posgreSQL
...
# Insert dataframe into local_wine table in posgreSQL
df.to_sql(
    table_name,
    engine,
    if_exists='replace',
